...
function App() {
  ...
  async function newContract() {
    ...
    console.log('New Contract Values:', beneficiary, arbiter, etherValue);
    ...
    const escrow = {
      ...
      arbiter,
      beneficiary,
      value: ethers.utils.formatUnits(weiValue, 'ether'),
      handleApprove: async () => {
  ...
  return (
    <>
      ...
      <div className="existing-contracts">
        ...
        <div id="container">
          {escrows.map((escrow) => {
            return <Escrow key={escrow.address} {...escrow} handleApprove={escrow.handleApprove}/>;
          })}
        </div>
      </div>
    </>
